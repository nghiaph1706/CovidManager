 ...
 * @author nghiacubu
 */
public class Nguoisd extends javax.swing.JFrame {

    /**
     * Creates new form DoiPass
     */
    public Nguoisd(User userTmp) {
        initComponents();
        ...
        txtName.setText("Tên: "+userTmp.getName());
        txtRole.setText("Quyền: "+userTmp.getRoler());
        txtUser.setText("Username "+userTmp.getUsername());
    ...
    private void initComponents() {
        ...
        txtRole.setBackground(new java.awt.Color(153, 204, 255));
        txtRole.setFont(new java.awt.Font("Sitka Text", 1, 18)); // NOI18N
        txtRole.setForeground(new java.awt.Color(0, 0, 153));
        txtRole.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        txtName.setBackground(new java.awt.Color(153, 204, 255));
        txtName.setFont(new java.awt.Font("Sitka Text", 1, 18)); // NOI18N
